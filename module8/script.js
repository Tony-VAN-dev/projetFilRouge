...
let cartCountHeader = document.getElementById("cartCount"); // le total
let cartCountAside = document.getElementById("cart-count-aside"); // nb d'articles

let cartTotalAside = document.getElementById("cart-total-aside"); // total aside
let cartMessage = document.getElementById("cart-message"); // message panier

//fonction getCartMessage
...
//   cartItemCount.textContent = cartCountAside;
//   cartTotal.textContent = cartTotalAside;
